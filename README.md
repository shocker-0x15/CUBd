...
しかし欠点として、CUBのヘッダーファイルをincludeするとCUDA特有の予約語などがソースコードに含まれてしまうことがあります。
...
However, it has a drawback that including CUB's header files brings CUDA-specific reserved words into the source code.
